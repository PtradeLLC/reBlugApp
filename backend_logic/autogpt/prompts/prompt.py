...
def construct_main_ai_config(config: Config) -> AIConfig:
    ...
    """
    # Set the default values for Name, Role, and Goals
    ai_name = "Forged AI"
    ai_role = "Data Analyst"
    ai_goals = [
        "Use the document file 'launchProduct.pdf' saved in '../../auto_gpt_workspace/' as your guide for tasks and goals to complete."
    ]
...
Continue ({config.authorise_key}/{config.exit_key}): """,
    ...
    if not ai_config.ai_name:
        ai_config.ai_name = ai_name
        ai_config.ai_role = ai_role
        ai_config.ai_goals = ai_goals
