...
const features = [
  ...
  },
  {
    ...
    description:
      "Earn revenue by selling products based on your blog's niche. Use 'bCommerce' feature to sell products directly to your readers without inventory management, product sourcing. We will provide the product and inventory management features, and AI agents trained to provide sales and support to your readers.",
  },
  {
  ...
  },
  {
    ...
    description:
      "'Foodhini Says' are tasks designed to help brands achieve their marketing goals by requesting specific actions to be completed. In return for completing these tasks, we along with our brand partners will issue a virtual card in your dashboard, and fund it regularly as you run the tasks for Foodhini . This mutually beneficial arrangement allows brands to effectively reach their target audience while you monetize the opportunities.",
  },
  {
