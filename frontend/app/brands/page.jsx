...
const features = [
  ...
  },
  {
    name: "Blog Pages",
    description:
      "Extend your blog pages with Article Assistant. Install a simple script and let the assistant chat with visitors on your website's blog pages. The assistant provides support, answers questions, sales or just chat with visitors about the product or service.",
  },
  {
      ...
      <div className="apply-margin mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 sm:px-6 sm:py-24 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
        <div id="maap">
          ...
          <h3 className="mt-4 text-gray-500">
            ...
            presence, engage their audience, and drive growth. Our suite of
