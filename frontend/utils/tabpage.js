...
const emailTab = `
Features:
1. Co-promotion: Opt in to partner with other brands and influencers in designated categories to reach a wider audience through Email ChatBot recommendations.
...
3. Email ChatBot: Answer questions, provide information, customer support using AI powered conversational Email ChatBot in emails / newsletters.
4. eCommerce: Have Email ChatBot double up as your sales agent by helping prospective customers find the products or services they're looking for, and guide them through the purchase process with this tool.
...
6. SMS: If the conversation needs to be transferred to a human representative, the Email ChatBot can connect the user to them via SMS messages.
`;
...
3. Auto Pilot: Answer questions, provide information, customer support using AI powered conversational Email ChatBot in emails / newsletters.
