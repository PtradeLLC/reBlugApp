const emailTab = `
Email Conversational Tool is an AI-powered marketing tool that helps businesses improve their email communication by embedding a chatbot into their emails and newsletters. ${<br />}
...
Here is an example of how Email Conversational Tool can be used: ${<br />}
A non-profit organization could use Email Conversational Tool to embed a chatbot into their donation email.${<br />} The chatbot could answer questions about the organization's mission and programs, and help donors make a donation.
${<br />}
An e-commerce company could use Email Conversational Tool to embed a chatbot into their product newsletter.${<br />} The chatbot could answer questions about the company's products, help customers place an order, and track their shipments.
${<br />}
