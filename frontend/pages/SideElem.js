function displayWebpage(url) {
  ...
  return (
    <div>
      <button onClick={() => window.open(url, "newWindow", "width=" + halfScreenWidth + ",height=600")}>
        Display Webpage
      </button>
    </div>
  );
...
//   useEffect(() => {
//     const isExternal = !window.opener;
//     if (isExternal) {
//       setOpen(true);
//     }
//   }, []);
...
//         <Dialog as="div" className="fixed inset-0 overflow-hidden" onClose={closePopUp}>
