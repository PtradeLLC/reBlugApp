...
export async function getServerSideProps(context) {
    ...
    try {
        const baseUrl = '/api/blog/categoryBySlug'
        // create posts based on category slug
        const postJob = await fetch(baseUrl, {
            method: 'POST',
            headers: {
        ...
        if (!postJob.ok) {
            throw new Error('Job is not created successfully')
        }
