      ...
      <main>
        <div className="mx-auto mt-32 max-w-7xl sm:mt-40 sm:px-6 lg:px-8">
          <div className="relative isolate overflow-hidden bg-white/5  px-6 py-24 text-center shadow-2xl sm:rounded-3xl sm:px-16">
            ...
            >
              <div
                className="aspect-[1404/767] w-[87.75rem]  opacity-25"
                style={{
                  clipPath:
            ...
            <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-12 gap-y-16 lg:mx-0 lg:min-w-full lg:max-w-none lg:flex-none lg:gap-y-8">
              <div className="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
                ...
                <button
                  ...
                  className="relative w-4/5 mt-5 -mr-px inline-flex bg-red-500 h-9 flex-1 items-center justify-center gap-x-3 rounded border border-transparent py-4 text-sm font-semibold text-white"
                >
                  Try this tool
                </button>
              </div>
              ...
              <div className="sm:w-80 sm:shrink lg:w-auto lg:flex-none">
                ...
                <div className="mt-2 text-base leading-7 text-gray-900">
                  ...
                  <ul className="bg-slate-500 p-4 text-white rounded-md">
                    ...
                    <li>Brand representations</li>
                    <li>Accept donations for contents well done</li>
