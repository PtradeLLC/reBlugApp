                        ...
                        posts
                            ...
                            .map((post) => {
                                ...
                                return (
                                    ...
                                    //     <div isFooterBlurred className="w-full h-[400px] bg-foreground-400 text-sm font-light col-span-12 sm:col-span-7">
                                    //         <div className="absolute bg-transparent backdrop-blur z-10 top-0 flex-col items-start">
                                    ...
                                    //             }
                                    //         </div>
                                    //         <div className="absolute bg-white bottom-0 z-10 border-t-1 border-default-600 dark:border-default-100">
