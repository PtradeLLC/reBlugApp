...
//       if (token) {
//         // Send email
//         console.log("email", email, "firstName", firstName, "token", token, "userId", userId, "provider", provider);
//         await SendNewEmail({ firstName: firstName, email: lowercaseEmail, token: token.token, userId: token.userId, provider: provider });
//       }
