                            ...
                            <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                                ...
                                <div className="grid grid-cols-1 items-start gap-4 lg:grid-cols-3 lg:gap-8">
                                    ...
                                    <div className="grid grid-cols-1 gap-4 lg:col-span-2">
                                        ...
                                        <section className={`mt-4 ${selectedComponent === "Campaign Automation" || selectedComponent === "Messaging Platform" ? "pointer-events-none blur-md cursor-none" : ""}`}>
                                            {selectedKpi && (
                                        ...
                                        <section className={`mt-4 ${selectedComponent === "Campaign Automation" || selectedComponent === "Messaging Platform" ? "blur-md pointer-events-none cursor-none" : ""}`}>
