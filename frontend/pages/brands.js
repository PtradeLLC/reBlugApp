...
const features = [
  { name: 'Article Assistant', description: 'Article Assistant is a game-changer for brands looking to elevate their websites user experience. This AI-powered tool enables brands to install and enable conversational ChatBots seamlessly on their websites blog pages. Grab and install the Article Assistant on your blog page and let it engage with your readers in real-time.' },
  { name: 'Email ChatBot', description: 'Create engaging email campaigns with interactive Email ChatBots that allow users to provide feedback, answer surveys, and even make purchases directly through the email. This level of interactivity sets your brand apart and encourages user participation.' },
    ...
    <>
      <div className="bg-white">
        <div className="apply-margin mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 sm:px-6 sm:py-24 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
          <div id="maap">
            <h2 className="text-xl font-bold tracking-tight text-gray-900 sm:text-2xl">Unlocking Growth with AI-Powered SaaS Tools</h2>
