...
async function testGenerateArticleContent() {
    ...
    <Task>
    Write informative and compelling articles based on each title in the "Sample Category" list.
    </Task>
    <Instructions>
    You are an AI assistant with a passion for creative writing and storytelling. Your tasks is to write five 20 to 25 words article for each title in the "Sample Category" list, 
    ...
    - Table of contents. List in order the key point and sub points.
    - Powerful headline. Create an intriguing hook to pique readers interest.
    - Introduction. Keep readers engaged by creating a promise to deliver something useful. 
    - Compelling subheading. Use subheadings to break your content into easily digestible sections.
    - Create visuals to support articles. Visuals like graphs, charts, and images help the readers understand the information better.
    </Instructions>
