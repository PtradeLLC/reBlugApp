                            ...
                            <ul role="list" className="space-y-2 sm:space-y-4">
                                <li className="flex space-x-3">
                                    ...
                                    <span className="mt-0.5 h-5 w-5 flex justify-center items-center rounded-full bg-red-50 text-red-600 dark:bg-red-800/30 dark:text-red-500">
                                        <svg className="flex-shrink-0 h-3.5 w-3.5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" stroke-linecap="round" strokeLinecap="round"><polyline points="20 6 9 17 4 12" /></svg>
                                    </span>
