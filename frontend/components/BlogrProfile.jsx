...
const profile = {
  ...
  about: `
    <p>This is your public profile. It is currently only visible to you, write something decent about yourself and click publish to make it public</p>
  `,
};
const directory = {
  A: [
          ...
          <Transition.Root show={sidebarOpen} as={Fragment}>
            <div>
              <Transition.Child
                ...
                leaveTo="opacity-0"
              >
                <Dialog.Backdrop className="fixed inset-0 bg-gray-600 bg-opacity-75" />
              </Transition.Child>
                  ...
                  <dl className="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                    <div className="sm:col-span-2">
                      ...
                      <dd
                        ...
                        className="mt-1 max-w-prose space-y-5 text-sm text-gray-500"
                      />
                      <span className="text-gray-400 text-sm text-right cursor-pointer">
                        Click to edit
                      </span>
                    </div>
                  </dl>
