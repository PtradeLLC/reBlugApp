...
const AuthPro = () => {
    ...
    return (
        <div className='mt-6 grid grid-cols-3 gap-4'>
            <span className="flex h-[35px] border rounded-[5px] shadow-gray-100 bg-white justify-center font-semibold text-lg items-center ">
                ...
                <Link className='mx-1 font-[Roboto]' href={google}>Google</Link>
            </span>
            <span className="flex h-[35px] font-semibold bg-[#039be5] rounded-md w-full items-center px-3 text-white">
            ...
            <span className="flex h-[35px] font-semibold bg-[#7e57c2] rounded-md w-full items-center px-3 text-white">
