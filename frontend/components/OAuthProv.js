    ...
    return (
        <div className='mt-6 grid grid-cols-3 gap-4'>
            <span className="flex h-[35px] border rounded-[5px] shadow-gray-100 bg-white justify-center text-base items-center ">
                ...
                <button type="button" className='mx-1 font-sans' onClick={() => signIn('google', { callbackUrl: "/dashboard" })}>Google</button>
            </span>
            <span className="flex h-[35px] text-base bg-[#039be5] rounded-md w-full items-center px-3 text-white">
                ...
                <button type="button" className='mx-1 font-sans' onClick={() => signIn('facebook', { callbackUrl: "/dashboard" })}>Facebook</button>
            </span>
            <span className="flex h-[35px] bg-[#7e57c2] rounded-md w-full items-center px-3 text-white">
                ...
                <button type="button" className='mx-1 font-sans' onClick={() => signIn('twitch', { callbackUrl: "/dashboard" })}>Twitch</button>
            </span>
        </div>
    )
}
