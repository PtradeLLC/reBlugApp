    ...
    return (
        <>
            ...
            <div className="grid grid-cols-2 gap-4 w-full">
                <div className="grid grid-cols-2 gap-4 w-full">
                    <div className="col-span-2 "><AreaActivities /></div>
                    <div className="col-span-2"><Earnings /></div>
                </div>
                <div className="grid grid-cols-2 gap-4 w-full">
                    <div className="col-span-2"><BlogActivities /></div>
                    <div className="col-span-2"><OpenVsClick /></div>
                </div>
            </div>
            <button type="button" onClick={handleButtonClick} className="inline-flex items-center px-4 py-3 rounded-lg hover:text-gray-900 bg-gray-50 hover:bg-gray-100 w-full dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white">
...
//                     </ul>
//                     <div>
//                         {showAllActive ? <AllActiveComponent /> : <AllActivitiesTab />}
//                     </div>
//                 </div>
//                 <div>
//                     <div className="py-2 mt-2 font-semibold px-2 text-md">Activity Summary</div>
