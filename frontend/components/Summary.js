...
export default function Summary() {
    ...
    return (
        <div className="bg-white py-10 border rounded-sm">
            <h2 className="px-4 text-base font-semibold leading-7 flex text-black sm:px-6 lg:px-8"><Square3Stack3DIcon className="text-base w-8 h-8 text-zinc-500" />Latest activity</h2>
