  ...
  return (
    <div className="relative w-full">
      {/* <p className="block text-sm font-medium leading-6 text-gray-900">
        ...
        <br /> (select multiple if applicable)
      </p> */}
      {/* <button
        type="button"
                ...
                <div className="flex items-center">
                  {selectedOptions &&
                    ...
                    selectedOptions.includes(option.id) && (
                      <span className="absolute text-black inset-y-0 right-0 flex items-center pr-4 cursor-pointer">
                        {option.name}
                      </span>
                    )}
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 border-b border-gray-900/10 pb-12 md:grid-cols-3">
          <div>
            ...
            <p className="mt-1 text-sm leading-6 text-gray-600">
              The purpose of this section is to gather some information about
              your product so we can create an Ideal Customer Profile.
            </p>
          </div>
