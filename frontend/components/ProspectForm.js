      ...
      >
        <div id="sib-form-container" className="sib-form-container">
          <div
            ...
            styles='font-size:16px; text-align:left; font-family:"Helvetica", sans-serif; color:#661d1d; background-color:#ffeded; border-radius:3px; border-color:#ff4949;max-width:540px;'
          >
          ...
          <div
            id="success-message"
            className="sib-form-message-panel"
            styles='font-size:16px; text-align:left; font-family:"Helvetica", sans-serif; color:#085229; background-color:#e7faf0; border-radius:3px; border-color:#13ce66;max-width:540px;'
          >
            <div className="sib-form-message-panel__text sib-form-message-panel__text--center">
              <svg
                viewBox="0 0 512 512"
          ...
          <div
            ...
            styles="text-align:center; background-color:rgba(255,255,255,1); max-width:540px; border-radius:3px; border-width:1px; border-color:#C0CCD9; border-styles:solid; direction:ltr"
          >
            <form
              id="sib-form"
              method="POST"
              action="https://e6b07e75.sibforms.com/serve/MUIFAAKZSd9MjE1QT036W7HlYh6sYGOCcwFoLlTvxCFHpMF4EcpXJK7fY6APv_dvbHYMmC9GqzkZm2XaIgpnCJFzaoMztQ_M_EWeRKDw-7_VkEZ0AyaWRCozYxk_UUSISrGD_ZjMCeVITC-fquvffaxl-He3NJ3pIZZSgNsd5ocahCCCZ0q6y9s3PN7bomiDlf26G_DmxKRul-kw"
              data-type="subscription"
            >
              <div styles="padding: 8px 0;">
                <div className="sib-input sib-form-block">
                  <div className="form__entry entry_block">
                    <div className="form__label-row ">
                      <label
                        className="entry__label"
                        styles='font-weight: 700; text-align:left; font-size:16px; text-align:left; font-weight:700; font-family:"Helvetica", sans-serif; color:#3c4858;'
                        htmlFor="EMAIL"
                        data-required="*"
                      >
                        Enter your email
                    ...
                    <label
                      ...
                      styles='font-size:16px; text-align:left; font-family:"Helvetica", sans-serif; color:#661d1d; background-color:#ffeded; border-radius:3px; border-color:#ff4949;'
                    ></label>
                    <label
                      className="entry__specification"
                      styles='font-size:12px; text-align:left; font-family:"Helvetica", sans-serif; color:#8390A4; text-align:left'
                    >
                ...
                <div className="sib-sms-field sib-form-block">
                  <div className="form__entry entry_block">
                    <div className="form__label-row ">
                      ...
                      >
                        ...
                        >
                          ...
                          <div className="entry__field" styles="width: 100%">
                            <input
                              type="tel"
                              className="input"
                              id="SMS"
                    ...
                    <label
                      ...
                      styles='font-size:12px; text-align:left; font-family:"Helvetica", sans-serif; color:#8390A4; text-align:left'
                    >
                      This number is used to reach you when someone wants to
                      contact you .
                    </label>
                  </div>
                </div>
              ...
              <div styles="padding: 8px 0;">
                <div className="sib-form-block sib-divider-form-block">
                  <div styles="border: 0; border-bottom: 1px solid #E5EDF6"></div>
                </div>
              </div>
              <div styles="padding: 8px 0;">
                <div
                  className="sib-form-block sib-image-form-block"
                  styles="text-align: center"
                >
                  <img
                    src=""
                  ...
                  <div className="form__entry entry_block">
                    <div className="form__label-row ">
                      <label
                        ...
                        htmlFor="PRODUCTURL"
                      >
                        Enter url for your Product or Brand
                      </label>
                      ...
                      <div className="entry__field">
                        <input
                          ...
                          name="PRODUCTURL"
                          autoComplete="off"
                          placeholder="https://www.producturl.com/product-one"
                        />
                      </div>
                    </div>
                    ...
                    <label
                      ...
                      styles='font-size:12px; text-align:left; font-family:"Helvetica", sans-serif; color:#8390A4; text-align:left'
                    >
                      Enter a link for your product or website.
                    </label>
                  </div>
                </div>
              </div>
              <div styles="padding: 8px 0;">
                <div className="sib-form-block" styles="text-align: right">
                  <button
                    className="sib-form-block__button sib-form-block__button-with-loader"
                    styles='font-size:16px; text-align:right; font-weight:700; font-family:"Helvetica", sans-serif; color:#FFFFFF; background-color:#3E4857; border-radius:3px; border-width:0px;'
                    form="sib-form"
                    type="submit"
                  >
                    <svg
