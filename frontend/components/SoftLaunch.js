                                            ...
                                            {success ? (
                                                ...
                                                <>
                                                    <p className="text-sm text-gray-500">
                                                        As we work hard to bring these tools to you,
                                                        please use this form to join our
                                                        growing list of amazing brands, bloggers and writer waiting
                                                        to be notified. We promise you would be the first to try them in<br />
                                                        <spa className="text-green-600 font-semibold">{count}</spa>
                                                    </p>
                                                </>
                                            )}
                                        </div>
                                            ...
                                            <div className="flex mt-5">
                                                {!success ? (
                                                    <>
                                                        ...
                                                        <button type="button" className="inline-flex w-1/5 justify-center rounded-md bg-red-600 px-3 py-2 text-sm font-thin text-white shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-red-50 hover:text-black sm:col-start-1 sm:mt-0" onClick={() => setOpen(false)}>Close</button>
                                                    </>
                                                ) : null}
                                            </div>
                                        </div>
