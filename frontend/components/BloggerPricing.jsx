...
const tiers = [
  // Replace with actual price IDs from your Stripe Dashboard
  {
    ...
    id: "default",
    price: {
      monthly: "price_monthly_default",
      annually: "price_annually_default",
    },
  ...
  },
  {
    ...
    id: "sponsorship",
    price: {
      monthly: "price_monthly_sponsorship",
      annually: "price_annually_sponsorship",
    },
    description: "The essentials to provide your best work for clients.",
        ...
        <div className="isolate mx-auto mt-10 grid max-w-md grid-cols-1 gap-8 md:max-w-2xl md:grid-cols-2 lg:max-w-4xl xl:mx-0 xl:max-w-none xl:grid-cols-4">
          {tiers.map((tier) => (
            ...
            >
              ...
              <button
                onClick={() => handleCheckout(tier.price[frequency.value])}
                className={classNames(
                  tier.mostPopular
...
//     features: [
//       "Write & Publish blogs",
//       "Basic Foodhini features",
//       "Access to Article Assistant",
//       "Ability to monetize blog",
//     ],
//     mostPopular: false,
//   },
//   {
