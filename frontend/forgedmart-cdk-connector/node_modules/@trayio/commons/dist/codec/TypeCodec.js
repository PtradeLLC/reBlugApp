...
class TypeCodec {
    ...
    decode(value) {
        ...
        const report = PathReporter_1.PathReporter.report(result);
        return (0, function_1.pipe)(result, E.mapLeft(() => new Error(report.join(', '))));
    }
}
exports.TypeCodec = TypeCodec;
TypeCodec.undefined = TypeCodec.fromDescriptor(t.undefined);
TypeCodec.unknown = TypeCodec.fromDescriptor(t.unknown);
TypeCodec.emptyRecord = TypeCodec.fromDescriptor(t.type({}));
