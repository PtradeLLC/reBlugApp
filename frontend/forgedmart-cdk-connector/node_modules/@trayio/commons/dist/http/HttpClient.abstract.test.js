...
function httpClientTest(httpClient) {
    ...
    function processHttpRequest(requestCodec, responseCodec, httpRequest, httpResponse, process, isMultiPartBody = false) {
        return __awaiter(this, void 0, void 0, function* () {
            if (isMultiPartBody) {
                ...
                let files;
                try {
                    [fields, files] = yield form.parse(httpRequest);
                }
                catch (err) {
                    console.error(err);
                    return;
    ...
    const convertFormidableFileToTrayFile = (file) => {
        ...
        return ({
            ...
            metadata: {
                name: (_a = file.originalFilename) !== null && _a !== void 0 ? _a : '',
                size: file.size,
            },
    ...
    const requestListener = (req, res) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (req.method === 'GET' && typeof req.headers['error'] === 'string') {
            ...
            ((_a = req.headers['content-type']) === null || _a === void 0 ? void 0 : _a.includes(Http_1.HttpContentType.MultipartRequestBody))) {
            res.writeHead(200, { [Http_1.HttpHeader.ContentType]: Http_1.HttpContentType.Json });
            yield processHttpRequest(testMultiPartBodyTypeCodec, testMultiPartBodyTypeCodec, req, res, (input) => input, true);
        }
        else {
            const customHeader = req.headers['x-custom-header'];
            res.writeHead(200, { [Http_1.HttpHeader.ContentType]: Http_1.HttpContentType.Json });
            yield processHttpRequest(testInputCodec, testResponseCodec, req, res, (input) => ({
                strField: customHeader,
    ...
    describe('HttpClient Test', () => {
        ...
        test('should send a GET request', () => __awaiter(this, void 0, void 0, function* () {
            const response = yield httpClient.execute(Http_1.HttpMethod.Get, baseUrl, {
        ...
        test('should send a POST request', () => __awaiter(this, void 0, void 0, function* () {
            const testInput = {
                inputField: 321,
            };
            const response = yield (0, function_1.pipe)((0, Task_1.createTaskEitherFromEither)(E.right(testInputCodec.encode(testInput))), TE.map((encoded) => serialization.serialize(encoded)), TE.chain((serializedInput) => httpClient.execute(Http_1.HttpMethod.Post, baseUrl, {
                headers: {
        ...
        test('should send a POST request with multipart body', () => __awaiter(this, void 0, void 0, function* () {
            yield fileStorage.delete('file1')();
            yield fileStorage.delete('file2')();
            const file1 = yield fileStorage.write({
                key: 'file1',
                metadata: {
                    name: 'file1',
                },
            ...
            const file2 = yield fileStorage.write({
                key: 'file2',
                metadata: {
                    name: 'file2',
                },
            ...
            const response = yield httpClient.execute(Http_1.HttpMethod.Post, baseUrl, {
                headers: {
                    'x-custom-header': 'customVal',
        ...
        test('should parse an internal error response', () => __awaiter(this, void 0, void 0, function* () {
            const response = yield httpClient.execute(Http_1.HttpMethod.Get, baseUrl, {
                headers: { error: '500' },
                pathParams: {},
                queryString: {},
        ...
        test('should parse a not found error response', () => __awaiter(this, void 0, void 0, function* () {
            const response = yield httpClient.execute(Http_1.HttpMethod.Get, baseUrl, {
                headers: { error: '404' },
                pathParams: {},
                queryString: {},
