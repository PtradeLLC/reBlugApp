              ...
              <div className="space-y-6 sm:space-y-8 mb-[105px]">
                ...
                <ul role="list" className="space-y-2 sm:space-y-4">
                  <li className="flex space-x-2">
                    ...
                    <span className="text-sm sm:text-base text-gray-500">
                      <span className="font-bold">Articulate</span> your
                      thoughts
                    </span>
                  </li>
                  <li className="flex space-x-3">
                    ...
                    {/* End Solid Check */}
                    <span className="text-sm sm:text-base text-gray-500">
                      <span className="font-bold">Improve article</span>{" "}
                      Engagement
                    </span>
                  </li>
                  <li className="flex space-x-3">
                  ...
                  <li className="flex space-x-3">
                    ...
                    {/* End Solid Check */}
                    <span className="text-sm text-left sm:text-base text-gray-500">
                      <span className="font-bold">AI tools</span> for
                      interaction reader engagement.
                    </span>
                  </li>
                  <li className="flex space-x-3">
                    {/* Solid Check */}
                ...
                <div>
                  <p className="text-gray-500 text-left">
                    Continue telling great stories and share them with the
                    world. It&apos;s what you do, and our job is to help you
                    grow your reach.
                  </p>
                </div>
                <div className="flex justify-start -space-x-3">
                  <img
                    className="inline-block size-8 rounded-md ring-2 ring-white dark:ring-gray-800"
