...
const DraftSidebar = () => {
  ...
  const [loadingPublished, setLoadingPublished] = useState(true); // Loading state for published posts
  ...
  const getPosts = async () => {
    setLoading(true);
    setLoadingPublished(true); // Set loading state for published posts to true
    ...
    try {
      ...
      setLoading(false);
      setLoadingPublished(false); // Set loading state for published posts to false
    }
  };
      ...
      <div className="mt-5 flex flex-grow flex-col">
        <nav aria-label="Sidebar" className="flex-1 space-y-8 bg-white px-2">
          ...
          <div className="">
            <h3
              id="projects-headline"
              className="px-3 text-md font-bold text-gray-900"
            >
            ...
            >
              {loadingPublished ? (
                <p>Loading published posts...</p> // Display loading state
