        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="px-10 pt-8 md:col-span-2">
            ...
            <div className="text-md my-3">
              ...
              platform's partnership with brands who are looking to launch and
              promote their products to highly targeted and engaged audience. We
              then encourage members to using funds disbursed by our platform to
              pay for their food orders via virtual debit cards.
            </div>
          </div>
        </div>
        <div className="text-md my-3">
...
//         <span className="text-lg my-3 font-bold">The Tool</span>
//         <div className="text-md my-3">
//           Drawing inspiration from the popular "Buy Now, Pay Later" trend, "Eat
//           Now, Pay Never" is a novel marketing tool and strategy that disrupts
//           the traditional food ordering process. This system allows our members
//           to indulge in their cravings, without the need for payment. The
//           responsibility for settling the bill falls on our platform's
//           partnership with brands who are looking to launch and promote their
//           products to highly targeted and engaged audience. We then encourage
//           members to using funds disbursed by our platform to pay for their food
//           orders via virtual debit cards.
//         </div>
//         <div className="text-md my-3">
//           Sure you have more questions, these are some of the questions we have
//           been asked.
//         </div>
//         <Accordion variant="splitted">
//           {Questions.map((question, index) => (
