  ...
  return (
    <div className="px-8 mt-4">
      ...
      <div className="text-md my-3">
        ...
        Now, Pay Never" is a novel marketing tool and strategy that disrupts the
        traditional food ordering process. This system allows our members to
        indulge in their cravings, without the need for payment. The
        responsibility for settling the bill falls on our platform's partnership
        with brands who are looking to launch and promote their products to
        highly targeted and engaged audience. We then encourage members to using
        funds disbursed by our platform to pay for their food orders via virtual
        debit cards.
      </div>
      <div className="text-md my-3">
