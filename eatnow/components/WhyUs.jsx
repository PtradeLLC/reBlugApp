...
export default function WhyENPN() {
  ...
  const Answers = [
    ...
    "You can get started by signing up for an account or logging in if you already have one, and then setting up your food service business. Our list of registered food service businesss is growing quickly, so we encourage you to register as soon as possible. We are excited to have you join us!",
