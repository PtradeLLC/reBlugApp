  ...
  return (
    <section className="py-2">
      <div className="max-w-screen-xl mx-auto px-4 md:px-8">
        <h2 className="text-2xl font-thin text-slate-700 mb-2">
          New Restaurants
        </h2>
            ...
            >
              <a href={items.href}>
                ...
                <div className="mt-3 space-y-2 border-t-small pt-3">
                  ...
                  <h3 className="text-lg text-black duration-150 group-hover:text-gray-500 font-medium">
                    {items.title}
                  </h3>
                  <p className="text-gray-900 text-sm duration-150 group-hover:text-gray-500 font-medium">
                    {items.desc}
                  </p>
                </div>
              </a>
