...
//   const handleNicheSelection = async (selectedNiche) => {
//     try {
//       const userId = user.$id;

//       // Example of sending selected niche to backend and updating if necessary
//       const response = await fetch(`/api/updateNiche`, {
//         method: "POST",
//         headers: {
//           "Content-Type": "application/json",
//         },
...
//       // Fetch updated niche from backend (optional if necessary)
//       const data = await response.json();
//       if (data && data.userNiche) {
//         setUserNiche(data.userNiche);
//       }
