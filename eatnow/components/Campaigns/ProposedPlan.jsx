...
//       const data = await response.json();
//       updateProviders(data.providers);
//       await fetchProviderFiles(data.providers);
//     } catch (error) {
//       console.error("Error fetching providers:", error);
//       setError("Failed to fetch providers. Please try again later.");
//     }
...
//   const fetchProviderFiles = async (connectedProviders) => {
//     const files = {};
...
//           `/api/getProviderFiles?providerId=${provider.integrationId}&userId=${user.$id}`
//         );
//         if (response.ok) {
//           const data = await response.json();
//           files[provider.integrationId] = data.files;
//         }
//       } catch (error) {
//         console.error(`Error fetching files for ${provider.name}:`, error);
//       }
//     }
...
//                     </Button>
//                     {provider.connected &&
//                       providerFiles[provider.integrationId] && (
//                         <div className="mt-2 text-sm text-gray-600">
//                           Connected file:{" "}
//                           {providerFiles[provider.integrationId][0]}
//                         </div>
//                       )}
//                   </div>
//                 ))}
