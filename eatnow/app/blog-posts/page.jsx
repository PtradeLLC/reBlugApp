    ...
    <>
      ...
      <div>
        ...
        <Button
          ...
          className="font-barlow-condensed article-assistant-button border border-black rotate-90 z-50 bg-slate-100 hover:bg-slate-50 hover:text-slate-800 text-black h-8 text-center font-semibold px-4 rounded-md animate-pulse"
        >
          <span className="flex">
            <Image
