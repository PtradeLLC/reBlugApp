// app/api/articleAssistant/route.js
import { body } from 'next/server';
import { NextResponse } from 'next/server';

export async function POST(request) {
    try {
        const formData = await body(request);
...
//         // Perform your logic here, e.g., calling an external API or processing the data

//         // Example response
//         return NextResponse.json({ message: `Received content: ${content}` });
//     } catch (error) {
...
//         try {
//             // Process the content and postContent
//             // Let's assume the processing logic is here and we get `responseMessage`

//             const responseMessage = `Received your message: ${content}. Processing for post: ${postContent}`;
